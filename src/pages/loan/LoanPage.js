...
const TABLE_HEAD = [
  { id: "loanId", label: "Admin_ID", alignRight: false },
  { id: "customerId", label: "Customer_ID", alignRight: false },
  { id: "fullName", label: "Full_Name", alignRight: false },
  { id: "loanAmount", label: "Loan_Amount", alignRight: false },
  { id: "loanBalance", label: "Loan_Balance", alignRight: false },
  { id: "installmentPlan", label: "InstallmentPlan", alignRight: false },
...
function applySortFilter(array, comparator, query) {
  ...
  if (query) {
    return filter(
      array,
      (_loan) =>
        _loan.customer.firstName.toLowerCase().indexOf(query.toLowerCase()) !== -1
    );
  }
...
export default function LoanPage() {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/BB/api/v1/loan", config)
      .then((response) => {
  ...
  const handleClick = (event, loanId) => {
    const selectedIndex = selected.indexOf(loanId);
    let newSelected = [];
    if (selectedIndex === -1) {
      newSelected = newSelected.concat(selected, loanId);
                      ...
                      return (
                        ...
                        >
                          <TableCell padding="checkbox">
                            <Checkbox
                              checked={selectedLoan}
                              onChange={(event) =>
                                handleClick(event, loanId)
                              }
                            />
                          </TableCell>
                          ...
                          <TableCell align="left">{loanBalance}</TableCell>
                          <TableCell align="left">{installmentPlan}</TableCell>
